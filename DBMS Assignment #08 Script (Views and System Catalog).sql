...
select SalesReps.Name,Offices.CIty from SalesReps,Offices where SalesReps.RepOffice=Offices.Office

--question 2

--customer name, product, description, quantity ordered and value of parts ordered.  The column heading for the customers name should be ‘CustName’ and the column heading for value of parts ordered should be ‘Value’.  

create view CustOrders as
select Company as CustName,Orders.Product   ,Products.Description, Orders.Qty  , Orders.Amount as Value   from Customers,Orders,Products
where Customers.CustNum=Orders.Cust and Orders.Product=Products.Product